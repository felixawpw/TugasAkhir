...
public class ImageGalleryCategoryModel implements Parcelable {
	...
	private ArrayList<MapsModel> mSubcategories;
	...
	protected ImageGalleryCategoryModel(Parcel in) {
		...
		if (in.readByte() == 0x01) {
			mSubcategories = new ArrayList<MapsModel>();
			in.readList(mSubcategories,
					MapsModel.class.getClassLoader());
		} else {
			mSubcategories = null;
		}
	...
	public ArrayList<MapsModel> getSubcategories() {
		return mSubcategories;
	}

	public void setSubcategories(
			ArrayList<MapsModel> subcategories) {

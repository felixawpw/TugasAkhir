...
package com.felixawpw.indoormaps.view;
...
public class MaterialRippleLayout extends FrameLayout {
    ...
    private void setPositionInAdapter() {
        if (rippleInAdapter) {
            positionInAdapter = findParentAdapterView().getPositionForView(com.felixawpw.indoormaps.view.MaterialRippleLayout.this);
        }
    }

    private boolean adapterPositionChanged() {
        if (rippleInAdapter) {
            int newPosition = findParentAdapterView().getPositionForView(com.felixawpw.indoormaps.view.MaterialRippleLayout.this);
     ...
     * Animations
     */
    private Property<com.felixawpw.indoormaps.view.MaterialRippleLayout, Float> radiusProperty
        = new Property<com.felixawpw.indoormaps.view.MaterialRippleLayout, Float>(Float.class, "radius") {
        @Override
        public Float get(com.felixawpw.indoormaps.view.MaterialRippleLayout object) {
            return object.getRadius();
        }

        @Override
        public void set(com.felixawpw.indoormaps.view.MaterialRippleLayout object, Float value) {
    ...
    private Property<com.felixawpw.indoormaps.view.MaterialRippleLayout, Integer> circleAlphaProperty
        = new Property<com.felixawpw.indoormaps.view.MaterialRippleLayout, Integer>(Integer.class, "rippleAlpha") {
        @Override
        public Integer get(com.felixawpw.indoormaps.view.MaterialRippleLayout object) {
            return object.getRippleAlpha();
        }

        @Override
        public void set(com.felixawpw.indoormaps.view.MaterialRippleLayout object, Integer value) {
    ...
    * Accessor
    ...
    private class PerformClickEvent implements Runnable {
        ...
        private void clickAdapterView(AdapterView<?> parent) {
            final int position = parent.getPositionForView(com.felixawpw.indoormaps.view.MaterialRippleLayout.this);
            final long itemId = parent.getAdapter() != null
                ? parent.getAdapter().getItemId(position)
                : 0;
            if (position != AdapterView.INVALID_POSITION) {
                parent.performItemClick(com.felixawpw.indoormaps.view.MaterialRippleLayout.this, position, itemId);
            }
        }
    }
    ...
    public static class RippleBuilder {
        ...
        public com.felixawpw.indoormaps.view.MaterialRippleLayout create() {
            com.felixawpw.indoormaps.view.MaterialRippleLayout layout = new com.felixawpw.indoormaps.view.MaterialRippleLayout(context);
            ...
            if (parent != null && parent instanceof com.felixawpw.indoormaps.view.MaterialRippleLayout) {

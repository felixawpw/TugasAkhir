package com.felixawpw.indoormaps.view.siv.mask;
...
public abstract class PorterImageView extends android.support.v7.widget.AppCompatImageView {
    private static final String TAG = com.felixawpw.indoormaps.view.siv.mask.PorterImageView.class.getSimpleName();

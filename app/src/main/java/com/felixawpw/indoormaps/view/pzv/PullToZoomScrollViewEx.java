package com.felixawpw.indoormaps.view.pzv;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    private static final String TAG = com.felixawpw.indoormaps.view.pzv.PullToZoomScrollViewEx.class.getSimpleName();
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * com.felixawpw.indoormaps.view.pzv.PullToZoomScrollViewEx.sInterpolator.getInterpolation(f1);

...
public class PullToZoomListViewEx extends PullToZoomBase<ListView> implements AbsListView.OnScrollListener {
    private static final String TAG = com.felixawpw.indoormaps.view.pzv.PullToZoomListViewEx.class.getSimpleName();
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * com.felixawpw.indoormaps.view.pzv.PullToZoomListViewEx.sInterpolator.getInterpolation(f1);

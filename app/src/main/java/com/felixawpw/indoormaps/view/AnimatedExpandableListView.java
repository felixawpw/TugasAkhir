...
public class AnimatedExpandableListView extends ExpandableListView {
    ...
    public static abstract class AnimatedExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        private com.felixawpw.indoormaps.view.AnimatedExpandableListView parent;

        private static final int STATE_IDLE = 0;
        private static final int STATE_EXPANDING = 1;
        private static final int STATE_COLLAPSING = 2;

        private void setParent(com.felixawpw.indoormaps.view.AnimatedExpandableListView parent) {
            this.parent = parent;
        }

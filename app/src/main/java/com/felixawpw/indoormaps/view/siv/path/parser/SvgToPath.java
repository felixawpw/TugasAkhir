...
public class SvgToPath {
    static final String TAG = com.felixawpw.indoormaps.view.siv.path.parser.SvgToPath.class.getSimpleName();
    private static final float DPI = 72.0f;

    public static PathInfo getSVGFromInputStream(InputStream inputStream) {
        return com.felixawpw.indoormaps.view.siv.path.parser.SvgToPath.parse(inputStream, true, DPI);
    }
    ...
    private static PathInfo parse(InputStream in, boolean ignoreDefs, float dpi)  {
        try {
            ...
            com.felixawpw.indoormaps.view.siv.path.parser.SvgToPath svgHandler = new com.felixawpw.indoormaps.view.siv.path.parser.SvgToPath(xr);

 ...
 */
package com.felixawpw.indoormaps.view.kbv;
...
public final class MathUtils {
    ...
    protected static boolean haveSameAspectRatio(RectF r1, RectF r2) {
        ...
        float srcRectRatio = com.felixawpw.indoormaps.view.kbv.MathUtils.truncate(com.felixawpw.indoormaps.view.kbv.MathUtils.getRectRatio(r1), 2);
        float dstRectRatio = com.felixawpw.indoormaps.view.kbv.MathUtils.truncate(com.felixawpw.indoormaps.view.kbv.MathUtils.getRectRatio(r2), 2);
